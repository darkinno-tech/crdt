...
**相关代码位置**：`clients/rust/src/ffi.rs:226-304`、`clients/python/crdt_rga/__init__.py:141-279`、`clients/swift/Sources/CRDTRGA/CRDTRGA.swift:33-182`、`clients/cpp/include/darkinno-tech/crdt_rga.hpp:63-171`
...
- `clients/cpp/include/darkinno-tech/crdt_rga.hpp`
