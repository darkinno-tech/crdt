...
The published root module, `github.com/darkinno-tech/crdt`, is the dependency-free
...
| Module family | Scope |
| --- | --- |
| root `github.com/darkinno-tech/crdt` | CRDT types, codecs, replica helpers, and core tools; no third-party requirements. |
...
the import path ambiguous. All internal `github.com/darkinno-tech/crdt...` requires
